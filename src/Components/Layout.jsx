...
import { FolderKanban, Users , LogIn} from 'lucide-react';
...
export const Layout = () => {
  ...
  return (
    <>
      <div className="flex items-center justify-start p-1 bg-white text-black h-auto border-b border-b-gray-300 shadow">
        ...
        <div className="flex items-center relative justify-end text-black p-2 font-montserrat ml-auto mr-4">
          ...
          <div className="absolute right-0 w-48 bg-white border rounded-md shadow-lg opacity-0 hover:opacity-100 transition duration-300">
            <div className='cursor-pointer block px-4 py-2 text-gray-800 hover:bg-gray-200' onClick={logout}>
